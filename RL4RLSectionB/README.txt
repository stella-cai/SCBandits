...
simulation_analysis_scripts: this folder contains python scripts used to analyze saved simulations and make plots
simulation_analysis_saves: plots from analysis are saved here

More detailed info for each folder is given in a README stored in each
