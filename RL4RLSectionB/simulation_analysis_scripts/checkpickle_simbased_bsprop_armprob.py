...
#EpsilonGreedyIsEffect/num_sims=5armProb=0.5/es=0.3epsilon=0.1/
    ...
    root_ts = "/home/jacobnogas/Sofia_Villar_Fall_2019/banditalgorithms/src/EpsilonGreedy/TS_sims_with_wo_bs/NoEffect_fixedbs_RL4RLMay8/num_sims={}armProb=0.5".format(num_sims)
